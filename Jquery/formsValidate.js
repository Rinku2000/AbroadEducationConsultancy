let fnameNode,ageNode,mobileNode,emailNode,passNode,c_passNode,checkboxNode;
let errorNode1,errorNode2,errorNode3,errorNode4,errorNode6,errorNode7;
$(function(){
     fnameNode=$("#fname");
     ageNode=$("#age");
     mobileNode=$("#contact");
     ...
     errorNode7=$("#error7");
     checkboxNode=$("#check");
     let array=[errorNode1,errorNode2,errorNode3,errorNode4,errorNode6,errorNode7];
...
function validate1(){
    ...
    if(fname===''){
        ...
        fnameNode.css({border:"2px solid black"});
        return false;
    }
    else{
...
function validate2(){
    ...
    if(age===''){
        ...
        ageNode.css({border:"2px solid black"});
        return false;
    }
    else{
...
function validate3(){
    ...
    if(mobile===''){
        ...
        mobileNode.css({border:"2px solid black"});
        return false;
    }
    else{
...
function validate4(){
    ...
    if(email===''){
        ...
        emailNode.css({border:"2px solid black"});
        return false;
    }
    else{
...
function validate7(){
    ...
    if(cpass===''){
        ...
        c_passNode.css({border:"2px solid black"});
        return false;
    }
    else{
